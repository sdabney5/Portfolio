...
### Getting Started
To get started, download or clone the repository to your local machine.
### Usage
...
### Notes
Please note that if the image is larger than 1000x1000, the program will resize it to 900x600. Also note that the program assumes the image is in RGB mode (not grayscale, CMYK, etc.).
